                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="mb-3 mb-md-0">
                                    <input type="text" class="form-control  px-4" style="height: 47px;" placeholder="출발지">
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="mb-3 mb-md-0">
                                    <input type="text" class="form-control  px-4" style="height: 47px;" placeholder="도착지">
                                </div>
                            </div>
                            <div class="col-md-5">
                                <div class="mb-3 mb-md-0">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3 mb-md-0">
                                    <input type="text" class="form-control  px-4" style="height: 47px;" placeholder="인원 수">
                                    </input>
                                </div>
                            </div>
                        </div>
