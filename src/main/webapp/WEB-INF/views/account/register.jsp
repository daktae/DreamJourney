				...
				<div class="regicon_wj">
					...
					<div class="mb-3" style="margin: 0 auto;">
						<label for="exampleFormControlInput1" class="form-label">닉네임</label><span style="margin-left: 10px;" class="nick_ok">사용 가능한
							닉네임입니다.</span> <span style="margin-left: 10px;" class="nick_already">중복된
							닉네임 입니다.</span>
						<input type="text" class="form-control" id="nick" required name="nickname"
							placeholder="닉네임(3~15자 이내)" maxlength="15" style="width: 90%;" oninput="checkNick()">
...
<input class="form-control mailChkInput"  required style="width:90%;" placeholder="인증번호 6자리를 입력해주세요!" disabled="disabled" maxlength="6">
					...
					<div class="mb-3" style="margin: 0 auto;">
						<label for="exampleFormControlInput1" class="form-label">전화번호</label><button id="telcheckBtn" style="margin-left:10px; margin-bottom:10px;" class="btn btn-primary" type="button" onclick="requestCert()">전화번호 인증</button>
							...
							전화번호 입니다.</span>
							<span style="margin-left: 10px;" class="tel_already">중복된
							전화번호 입니다.</span> 	
						...
						<div style="margin-top: 10px; background-color: #EDF1FC;">
							...
							<div class="form-check" style="margin-top: 20px;">
								<input class="form-checkInput" type="checkbox" value="" required
									...
									for="flexCheckDefault"> 본인은 개인정보 처리방침에 따라 제 3자에게 본인의 개인
									정보를 제공하는 것에 동의합니다. <span style="color: #6268FF;">[필수]</span>
								</label>
							</div>
						</div>
						<div
